...
// XnLib compatibility defines
#ifndef XN_MAX_UINT16
#define XN_MAX_UINT16 0xFFFF
#endif
#ifndef XN_NEW
...
public:
	...
	virtual OniStatus convertC2DCoordinates(int /*depthX*/, int /*depthY*/, OniDepthPixel /*depthZ*/, int* /*pColorX*/, int* /*pColorY*/) { return ONI_STATUS_NOT_SUPPORTED; }

	virtual OniStatus convertD2CCoordinates(int /*depthX*/, int /*depthY*/, OniDepthPixel /*depthZ*/, int* /*pColorX*/, int* /*pColorY*/) { return ONI_STATUS_NOT_SUPPORTED; }
protected:
...
{																															\
	return pDepthStream->convertDepthToColorCoordinates(pColorStream, depthX, depthY, depthZ, pColorX, pColorY);			\
                                                                                                                            ...
                                                                                                                            \
ONI_C_API_EXPORT OniStatus oniDriverStreamConvertC2DCoordinates(oni::driver::StreamBase* pDepthStream,				\
	                                int colorX, int colorY, OniDepthPixel depthZ, int* pDepthX, int* pDepthY)		\
{																															\
	return pDepthStream->convertC2DCoordinates(colorX, colorY, depthZ, pDepthX, pDepthY);			\
}																															\
																															\
ONI_C_API_EXPORT OniStatus oniDriverStreamConvertD2CCoordinates(oni::driver::StreamBase* pDepthStream,				\
	                               int colorX, int colorY, OniDepthPixel depthZ, int* pDepthX, int* pDepthY)		\
{																															\
	return pDepthStream->convertD2CCoordinates(colorX, colorY, depthZ, pDepthX, pDepthY);			\
}																															\
																															\
